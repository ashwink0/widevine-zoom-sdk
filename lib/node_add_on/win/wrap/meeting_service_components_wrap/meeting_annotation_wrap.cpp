...
IMPL_FUNC_0(IAnnotationController, getAnnotationLegalNoticesPrompt, const wchar_t*, NULL)
//virtual const wchar_t* getAnnotationLegalNoticesExplained() = 0;
IMPL_FUNC_0(IAnnotationController, getAnnotationLegalNoticesExplained, const wchar_t*, NULL)
