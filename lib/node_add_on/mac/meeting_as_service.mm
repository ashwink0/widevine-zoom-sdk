...
bool ZMeetingAnnotationWrap::IsAnnotationLegalNoticeAvailable()
{
    ...
    ZoomSDKAnnotationController *annotationController = [controller getAnnotationController];
    if(!annotationController)
        return  false;
    
    return [annotationController isAnnotationLegalNoticeAvailable];
}
...
ZoomSTRING ZMeetingAnnotationWrap::GetAnnotationLegalNoticesPrompt()
{
    ...
    if(!annotationController)
        return  "";
    NSString *annotationStr = [annotationController getAnnotationLegalNoticesPrompt];
    return annotationStr ? [annotationStr UTF8String] : "";
}
...
ZoomSTRING ZMeetingAnnotationWrap::GetAnnotationLegalNoticesExplained()
{
    ...
    if(!annotationController)
        return  "";
    NSString *annotationShareStr = [annotationController getAnnotationLegalNoticesExplained];
    return annotationShareStr ? [annotationShareStr UTF8String] : "";
}
